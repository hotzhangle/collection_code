...
my($pbp_win32)= 'pcore/tools/pbp.exe';
my($pbp_linux)= 'pcore/tools/pbp';
my($key)      = 'pcore/tools/key_info.ini';
my($key_pubk) = 'pcore/tools/key_info_pubk.ini';
my($setting)  = 'pcore/tools/brom_setting.ini';
